...
urlpatterns = [
    ...
    path('success_create', views.success_create_view, name='success_create'),
    path('manage_records', views.manage_records_view, name='manage_records'),
    path('police_edit_options', views.police_edit_options_view, name='police_edit_options'),
    path('customs_edit_options', views.customs_edit_options_view, name='customs_edit_options'),
    path('lta_edit_options', views.lta_edit_options_view, name='lta_edit_options'),
    ...
    path('search_edit/<str:type>/', views.SearchEditListView.as_view(), name='search_edit_with_type'),
